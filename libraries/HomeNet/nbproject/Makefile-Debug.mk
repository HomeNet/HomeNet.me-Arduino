...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/WinAVR-Windows/homenet.exe

dist/Debug/WinAVR-Windows/homenet.exe: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1730660635/PortsBMP085.o: C/mp/arduino-0021/libraries/Ports/PortsBMP085.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1730660635/PortsBMP085.o C/mp/arduino-0021/libraries/Ports/PortsBMP085.cpp

${OBJECTDIR}/_ext/546314031/LibHumidity.o: ../LibHumidity/old2/LibHumidity.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/546314031
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/546314031/LibHumidity.o ../LibHumidity/old2/LibHumidity.cpp

${OBJECTDIR}/HomeNetDevicesButton.o: HomeNetDevicesButton.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HomeNetDevicesButton.o HomeNetDevicesButton.cpp

${OBJECTDIR}/HomeNetDevices.o: HomeNetDevices.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HomeNetDevices.o HomeNetDevices.cpp

${OBJECTDIR}/_ext/156170367/LibHumidity.o: ../LibHumidity/old/LibHumidity.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/156170367
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/156170367/LibHumidity.o ../LibHumidity/old/LibHumidity.cpp

${OBJECTDIR}/_ext/82737666/RF12.o: C/mp/arduino-0021/libraries/RF12/RF12.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/82737666
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/82737666/RF12.o C/mp/arduino-0021/libraries/RF12/RF12.cpp

${OBJECTDIR}/_ext/1730660635/Ports.o: C/mp/arduino-0021/libraries/Ports/Ports.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1730660635
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1730660635/Ports.o C/mp/arduino-0021/libraries/Ports/Ports.cpp

${OBJECTDIR}/_ext/156170178/LibHumidity.o: ../LibHumidity/org/LibHumidity.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/156170178
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/156170178/LibHumidity.o ../LibHumidity/org/LibHumidity.cpp

${OBJECTDIR}/_ext/82737666/RF12sio.o: C/mp/arduino-0021/libraries/RF12/RF12sio.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/82737666
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/82737666/RF12sio.o C/mp/arduino-0021/libraries/RF12/RF12sio.cpp

${OBJECTDIR}/HomeNet.o: HomeNet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HomeNet.o HomeNet.cpp

${OBJECTDIR}/PortsSHT21.o: PortsSHT21.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/PortsSHT21.o PortsSHT21.cpp

${OBJECTDIR}/_ext/1730660635/PortsLCD.o: C/mp/arduino-0021/libraries/Ports/PortsLCD.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1730660635
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1730660635/PortsLCD.o C/mp/arduino-0021/libraries/Ports/PortsLCD.cpp

${OBJECTDIR}/_ext/156171526/PortsSHT21.o: ../LibHumidity/new/PortsSHT21.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/156171526
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/156171526/PortsSHT21.o ../LibHumidity/new/PortsSHT21.cpp

${OBJECTDIR}/_ext/1730660635/PortsSHT11.o: C/mp/arduino-0021/libraries/Ports/PortsSHT11.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1730660635
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1730660635/PortsSHT11.o C/mp/arduino-0021/libraries/Ports/PortsSHT11.cpp

${OBJECTDIR}/_ext/1730660635/PortsRF12.o: C/mp/arduino-0021/libraries/Ports/PortsRF12.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1730660635
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1730660635/PortsRF12.o C/mp/arduino-0021/libraries/Ports/PortsRF12.cpp

${OBJECTDIR}/HomeNetDeviceLCD.o: HomeNetDeviceLCD.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HomeNetDeviceLCD.o HomeNetDeviceLCD.cpp

${OBJECTDIR}/_ext/666785897/LibHumidity.o: ../LibHumidity/LibHumidity.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/666785897
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/666785897/LibHumidity.o ../LibHumidity/LibHumidity.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/WinAVR-Windows/homenet.exe
